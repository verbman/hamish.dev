      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-5 col-sm-12 py-2 pe-4-md text-center text-md-end">
            <a rel="me" href="https://mastodon.nz/@verbman" aria-label="@verbman@mastodon.nz"><Mastodon width={"18"} height={"18"} color={'#00ab6b'} className="rss-svg" /></a> &nbsp;
            <a target="_blank" rel="noreferrer" href="https://hamish.dev/feed.xml" aria-label="RSS" >
